    ...
    */
    function mkdfInitAudioPlayer() {
	    var players = $('audio.mkdf-blog-audio'),
            blogHolder = $('article.format-audio');
        ...
        if (blogHolder.length) {
            blogHolder.each(function () {
                var thisAudio = $(this),
                    blogCat = thisAudio.find('.mkdf-post-info-date'),
                    audioControls = thisAudio.find('.mejs-controls');
	...
	function mkdfInitBlogPagination(){
		...
		var initMainPagFunctionality = function(thisHolder) {
			...
			if(nextPage <= maxNumPages){
				...
				var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'attika_mikado_blog_load_more');
    ...
    function mkdfInitBlogListShortcodePagination(){
        ...
        var initMainPagFunctionality = function(thisHolder, pagedLink) {
            ...
            if(nextPage <= maxNumPages){
                ...
                var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'attika_mikado_blog_shortcode_load_more');
...
(function($) {
    ...
    /*
    Function that initializes portfolio trio
     */

    function mkdfInitPortfolioTrio(){
    	var portfolioTrio = $('.mkdf-portfolio-list-holder.mkdf-pl-trio');

        if (portfolioTrio.length) {
            portfolioTrio.each(function() {
                var thisPortfolioTrio = $(this),
                    middleArticle = thisPortfolioTrio.find('.mkdf-pl-item:nth-child(2)'),
                    lastArticle = thisPortfolioTrio.find('.mkdf-pl-item:nth-child(3)');

                var imageHeightDiff = lastArticle.find('.mkdf-pli-image').outerHeight() - middleArticle.find('.mkdf-pli-image').outerHeight();

                lastArticle.css('margin-top', -imageHeightDiff);
                thisPortfolioTrio.css({'padding-top':imageHeightDiff, 'padding-bottom':imageHeightDiff });
                thisPortfolioTrio.css('visibility', 'visible');
            });
		}
    }
    ...
    function mkdfInitLoadMoreItemsPortfolioFilter($portfolioList, $filterValue, $filterClassName) {
        ...
        var	loadMoreDatta = mkdf.modules.common.getLoadMoreData(thisPortList),
            nextPage = loadMoreDatta.nextPage,
	        ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'attika_core_portfolio_ajax_load_more'),
	...
	function mkdfInitPortfolioPagination(){
		...
		var initMainPagFunctionality = function(thisPortList, pagedLink) {
			...
			if(nextPage <= maxNumPages || maxNumPages === 0){
				...
				var ajaxData = mkdf.modules.common.setLoadMoreAjaxData(loadMoreDatta, 'attika_core_portfolio_ajax_load_more');
