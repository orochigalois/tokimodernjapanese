...
if ( ! function_exists( 'attika_mikado_fonts_options_map' ) ) {
	/**
	 * Font options page
	 */
	function attika_mikado_fonts_options_map() {
		
		attika_mikado_add_admin_page(
			array(
				'slug'  => '_fonts_page',
				'title' => esc_html__( 'Fonts', 'attika' ),
				'icon'  => 'fa fa-font'
			)
		);
		 ...
		 * Headings
		 */
		$panel_headings = attika_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_headings',
				'title' => esc_html__( 'Headings', 'attika' )
			)
		);
		
		//H1
		$group_heading_h1 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h1',
				'title'       => esc_html__( 'H1 Style', 'attika' ),
				'description' => esc_html__( 'Define styles for h1 heading', 'attika' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h1_1 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'args'          => array(
					'suffix' => esc_html__( 'px / em', 'attika' )
				),
				'parent'        => $row_heading_h1_1
			)
		);
		...
		$row_heading_h1_2 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h1_3 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'name'          => 'h1_margin_top',
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top (px)', 'attika' ),
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom (px)', 'attika' ),
				'parent'        => $row_heading_h1_3
			)
		);
		
		//H2
		$group_heading_h2 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h2',
				'title'       => esc_html__( 'H2 Style', 'attika' ),
				'description' => esc_html__( 'Define styles for h2 heading', 'attika' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h2_1 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_2 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h2_3 = attika_mikado_add_admin_row(
			array(
		...
		//H3
		$group_heading_h3 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h3',
				'title'       => esc_html__( 'H3 Style', 'attika' ),
				'description' => esc_html__( 'Define styles for h3 heading', 'attika' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h3_1 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_2 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h3_3 = attika_mikado_add_admin_row(
			array(
		...
		//H4
		$group_heading_h4 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h4',
				'title'       => esc_html__( 'H4 Style', 'attika' ),
				'description' => esc_html__( 'Define styles for h4 heading', 'attika' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h4_1 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_2 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h4_3 = attika_mikado_add_admin_row(
			array(
		...
		//H5
		$group_heading_h5 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h5',
				'title'       => esc_html__( 'H5 Style', 'attika' ),
				'description' => esc_html__( 'Define styles for h5 heading', 'attika' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h5_1 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_2 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h5_3 = attika_mikado_add_admin_row(
			array(
		...
		//H6
		$group_heading_h6 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_heading_h6',
				'title'       => esc_html__( 'H6 Style', 'attika' ),
				'description' => esc_html__( 'Define styles for h6 heading', 'attika' ),
				'parent'      => $panel_headings
			)
		);
		
		$row_heading_h6_1 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_2 = attika_mikado_add_admin_row(
			array(
		...
		$row_heading_h6_3 = attika_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings3 = attika_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings3',
				'title' => esc_html__( 'Headings Responsive (Tablet Landscape View)', 'attika' )
			)
		);
		
		//H1
		$group_responsive3_heading_h1 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h1',
				'title'       => esc_html__( 'H1 Responsive Style', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for h1 heading', 'attika' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h1_3 = attika_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive3_heading_h2 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h2',
				'title'       => esc_html__( 'H2 Responsive Style', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for h2 heading', 'attika' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h2_3 = attika_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive3_heading_h3 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h3',
				'title'       => esc_html__( 'H3 Responsive Style', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for h3 heading', 'attika' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h3_3 = attika_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive3_heading_h4 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h4',
				'title'       => esc_html__( 'H4 Responsive Style', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for h4 heading', 'attika' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h4_3 = attika_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive3_heading_h5 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h5',
				'title'       => esc_html__( 'H5 Responsive Style', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for h5 heading', 'attika' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h5_3 = attika_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive3_heading_h6 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_responsive3_heading_h6',
				'title'       => esc_html__( 'H6 Responsive Style', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for h6 heading', 'attika' ),
				'parent'      => $panel_responsive_headings3
			)
		);
		
		$row_responsive_heading_h6_3 = attika_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings = attika_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings',
				'title' => esc_html__( 'Headings Responsive (Tablet Portrait View)', 'attika' )
			)
		);
		
		//H1
		$group_responsive_heading_h1 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h1_1 = attika_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive_heading_h2 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h2_1 = attika_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive_heading_h3 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h3_1 = attika_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive_heading_h4 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h4_1 = attika_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive_heading_h5 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h5_1 = attika_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive_heading_h6 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive_heading_h6_1 = attika_mikado_add_admin_row(
			array(
		 ...
		 */
		$panel_responsive_headings2 = attika_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_responsive_headings2',
				'title' => esc_html__( 'Headings Responsive (Mobile Devices)', 'attika' )
			)
		);
		
		//H1
		$group_responsive2_heading_h1 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h1_1 = attika_mikado_add_admin_row(
			array(
		...
		//H2
		$group_responsive2_heading_h2 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h2_1 = attika_mikado_add_admin_row(
			array(
		...
		//H3
		$group_responsive2_heading_h3 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h3_1 = attika_mikado_add_admin_row(
			array(
		...
		//H4
		$group_responsive2_heading_h4 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h4_1 = attika_mikado_add_admin_row(
			array(
		...
		//H5
		$group_responsive2_heading_h5 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h5_1 = attika_mikado_add_admin_row(
			array(
		...
		//H6
		$group_responsive2_heading_h6 = attika_mikado_add_admin_group(
			array(
		...
		$row_responsive2_heading_h6_1 = attika_mikado_add_admin_row(
			array(
		 ...
		 * Text
		 */
		$panel_text = attika_mikado_add_admin_panel(
			array(
				'page'  => '_fonts_page',
				'name'  => 'panel_text',
		...
		$group_text = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_text',
				'title'       => esc_html__( 'Paragraph', 'attika' ),
				'description' => esc_html__( 'Define styles for paragraph text', 'attika' ),
				'parent'      => $panel_text
			)
		);
		
		$row_text_1 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
				'parent' => $group_text
			)
		...
		$row_text_2 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_text_2',
				'parent' => $group_text,
				'next'   => true
		...
		$row_text_3 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_text_3',
				'parent' => $group_text,
				'next'   => true
		...
		$group_text_res1 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res1',
				'title'       => esc_html__( 'Paragraph Responsive (Tablet Portrait View)', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for tablet devices - portrait view', 'attika' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_1 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_text_1',
		...
		$group_text_res2 = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_text_res2',
				'title'       => esc_html__( 'Paragraph Responsive (Mobile Devices)', 'attika' ),
				'description' => esc_html__( 'Define responsive styles for paragraph text for mobile devices', 'attika' ),
				'parent'      => $panel_text
			)
		);
		
		$row_res_text_2 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_res_text_2',
		...
		$group_link = attika_mikado_add_admin_group(
			array(
				'name'        => 'group_link',
				'title'       => esc_html__( 'Links', 'attika' ),
				'description' => esc_html__( 'Define styles for link text', 'attika' ),
				'parent'      => $panel_text
			)
		);
		
		$row_link_1 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_link_1',
				'parent' => $group_link
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'name'          => 'link_color',
				'default_value' => '',
				'label'         => esc_html__( 'Link Color', 'attika' ),
				'parent'        => $row_link_1
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover Link Color', 'attika' ),
				'parent'        => $row_link_1
			)
		);
		
		$row_link_2 = attika_mikado_add_admin_row(
			array(
				'name'   => 'row_link_2',
				'parent' => $group_link,
				'next'   => true
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Link Decoration', 'attika' ),
				'options'       => attika_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hovel Link Decoration', 'attika' ),
				'options'       => attika_mikado_get_text_decorations(),
				'parent'        => $row_link_2
			)
		);
	...
	add_action( 'attika_mikado_action_options_map', 'attika_mikado_fonts_options_map', attika_mikado_set_options_map_position( 'fonts' ) );
}