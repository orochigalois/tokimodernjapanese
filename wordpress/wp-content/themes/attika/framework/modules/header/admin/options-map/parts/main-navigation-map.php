...
if ( ! function_exists( 'attika_mikado_get_hide_dep_for_header_main_menu_options' ) ) {
	function attika_mikado_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'attika_mikado_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'attika_mikado_header_main_navigation_options_map' ) ) {
	function attika_mikado_header_main_navigation_options_map() {
		$hide_dep_options = attika_mikado_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = attika_mikado_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'attika' ),
		...
		attika_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'attika' )
			)
		);
		...
		$drop_down_group = attika_mikado_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'attika' )
			)
		);
		
		$drop_down_row1 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'attika' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'attika' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'attika' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'attika' )
				)
			)
		);
		...
		$first_level_group = attika_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'first_level_group',
				'title'       => esc_html__( '1st Level Menu', 'attika' ),
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'attika' )
			)
		);
		
		$first_level_row1 = attika_mikado_add_admin_row(
			array(
		...
		$first_level_row3 = attika_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'attika' ),
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'attika' ),
			)
		);
		
		$first_level_row4 = attika_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'attika' ),
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'attika' ),
			)
		);
		
		$first_level_row5 = attika_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = attika_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = attika_mikado_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = attika_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_group',
				'title'       => esc_html__( '2nd Level Menu', 'attika' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'attika' )
			)
		);
		
		$second_level_row1 = attika_mikado_add_admin_row(
			array(
		...
		$second_level_row2 = attika_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_row3 = attika_mikado_add_admin_row(
			array(
				'parent' => $second_level_group,
		...
		$second_level_wide_group = attika_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'attika' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'attika' )
			)
		);
		
		$second_level_wide_row1 = attika_mikado_add_admin_row(
			array(
		...
		$second_level_wide_row2 = attika_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = attika_mikado_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = attika_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_group',
				'title'       => esc_html__( '3nd Level Menu', 'attika' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'attika' )
			)
		);
		
		$third_level_row1 = attika_mikado_add_admin_row(
			array(
		...
		$third_level_row2 = attika_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_row3 = attika_mikado_add_admin_row(
			array(
				'parent' => $third_level_group,
		...
		$third_level_wide_group = attika_mikado_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'attika' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'attika' )
			)
		);
		
		$third_level_wide_row1 = attika_mikado_add_admin_row(
			array(
		...
		$third_level_wide_row2 = attika_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = attika_mikado_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'attika_mikado_action_header_main_navigation_options_map', 'attika_mikado_header_main_navigation_options_map', 10, 1 );
}