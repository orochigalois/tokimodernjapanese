...
class HeaderDivided extends HeaderType {
	...
	public function loadTemplate( $parameters = array() ) {
		...
		$parameters['menu_area_in_grid'] = attika_mikado_get_meta_field_intersect( 'menu_area_in_grid', $id ) == 'yes' ? true : false;
		
		$parameters = apply_filters( 'attika_mikado_filter_header_divided_parameters', $parameters );
	...
	public function calculateHeightOfTransparency() {
		...
		$menu_background_color             = attika_mikado_get_meta_field_intersect( 'menu_area_background_color', $id );
		$menu_background_transparency      = attika_mikado_get_meta_field_intersect( 'menu_area_background_transparency', $id );
		$menu_grid_background_color        = attika_mikado_options()->getOptionValue( 'menu_area_grid_background_color' );
		$menu_grid_background_transparency = attika_mikado_options()->getOptionValue( 'menu_area_grid_background_transparency' );
		...
		if ( $menuAreaTransparent ) {
			...
			if ( ( $sliderExists && attika_mikado_is_top_bar_enabled() )
			     || attika_mikado_is_top_bar_enabled() && attika_mikado_is_top_bar_transparent()
			) {
				$transparencyHeight += attika_mikado_get_top_bar_height();
			}
		}
	...
	public function calculateHeightOfCompleteTransparency() {
		...
		$menu_background_color             = attika_mikado_options()->getOptionValue( 'menu_area_background_color' );
		$menu_background_transparency      = attika_mikado_options()->getOptionValue( 'menu_area_background_transparency' );
		$menu_grid_background_color        = attika_mikado_options()->getOptionValue( 'menu_area_grid_background_color' );
		$menu_grid_background_transparency = attika_mikado_options()->getOptionValue( 'menu_area_grid_background_transparency' );
	...
	public function calculateHeaderHeight() {
		...
		if ( attika_mikado_is_top_bar_enabled() ) {
			$headerHeight += attika_mikado_get_top_bar_height();
		}
	...
	public function getPerPageJSVariables( $perPageVars ) {
		...
		$header_behavior = attika_mikado_get_meta_field_intersect( 'header_behaviour' );
