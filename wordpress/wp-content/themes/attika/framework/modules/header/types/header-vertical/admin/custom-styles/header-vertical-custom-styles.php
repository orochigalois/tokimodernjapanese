...
if ( ! function_exists( 'attika_mikado_vertical_menu_styles' ) ) {
	function attika_mikado_vertical_menu_styles() {
	...
	add_action( 'attika_mikado_action_style_dynamic', 'attika_mikado_vertical_menu_styles' );
}

if ( ! function_exists( 'attika_mikado_vertical_main_menu_styles' ) ) {
	/**
	 * Generates styles for vertical main main menu
	 */
	function attika_mikado_vertical_main_menu_styles() {
		$menu_holder_styles = array();
		
		$menu_top_margin    = attika_mikado_options()->getOptionValue( 'vertical_menu_top_margin' );
		$menu_bottom_margin = attika_mikado_options()->getOptionValue( 'vertical_menu_bottom_margin' );
		
		if ( ! empty( $menu_top_margin ) ) {
			$menu_holder_styles['margin-top'] = attika_mikado_filter_px( $menu_top_margin ) . 'px';
		}
		if ( ! empty( $menu_bottom_margin ) ) {
			$menu_holder_styles['margin-bottom'] = attika_mikado_filter_px( $menu_bottom_margin ) . 'px';
		}
		...
		echo attika_mikado_dynamic_css( $menu_holder_selector, $menu_holder_styles );
	...
	add_action( 'attika_mikado_action_style_dynamic', 'attika_mikado_vertical_main_menu_styles' );
}