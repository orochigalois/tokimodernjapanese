...
if ( class_exists( 'AttikaCoreClassWidget' ) ) {
    class AttikaMikadoClassContactForm7Widget extends AttikaCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_contact_form_7_widget',
                esc_html__( 'Attika Contact Form 7 Widget', 'attika' ),
                array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'attika' ) )
            );
        ...
        protected function setParams() {
            ...
            $this->params = array(
                array(
                    'type'  => 'textfield',
                    'name'  => 'extra_class',
                    'title' => esc_html__( 'Extra Class Name', 'attika' )
                ),
                array(
                    'type'  => 'textfield',
                ...
                array(
                    'type'    => 'dropdown',
                    'name'    => 'contact_form',
                    'title'   => esc_html__( 'Select Contact Form 7', 'attika' ),
                    'options' => $contact_forms
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'contact_form_style',
                    'title'   => esc_html__( 'Contact Form 7 Style', 'attika' ),
                    'options' => array(
        ...
        public function widget( $args, $instance ) {
            ...
            ?>
            <div class="widget mkdf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo attika_mikado_get_inline_style( $widget_styles ); ?>>
