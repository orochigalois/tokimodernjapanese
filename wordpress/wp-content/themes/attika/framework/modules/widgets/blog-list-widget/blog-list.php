...
if ( class_exists( 'AttikaCoreClassWidget' ) ) {
    class AttikaMikadoClassBlogListWidget extends AttikaCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_blog_list_widget',
                esc_html__( 'Attika Blog List Widget', 'attika' ),
                array( 'description' => esc_html__( 'Display a list of your blog posts', 'attika' ) )
            );
            ...
            $this->params = array(
                ...
                array(
                    ...
                    'options' => array(
                        ...
                        'minimal' => esc_html__( 'Minimal', 'attika' )
                    )
                ),
                array(
                    'type'  => 'textfield',
                    'name'  => 'number_of_posts',
                    'title' => esc_html__( 'Number of Posts', 'attika' )
                ),
                array(
                    'type'    => 'dropdown',
                ...
                array(
                    'type'    => 'dropdown',
                    'name'    => 'orderby',
                    'title'   => esc_html__( 'Order By', 'attika' ),
                    'options' => attika_mikado_get_query_order_by_array()
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'order',
                    'title'   => esc_html__( 'Order', 'attika' ),
                    'options' => attika_mikado_get_query_order_array()
                ),
                array(
                    'type'        => 'textfield',
                    'name'        => 'category',
                    'title'       => esc_html__( 'Category Slug', 'attika' ),
                    'description' => esc_html__( 'Leave empty for all or use comma for list', 'attika' )
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'title_tag',
                ...
                array(
                    ...
                    'title'   => esc_html__( 'Title Text Transform', 'attika' ),
        ...
        public function widget( $args, $instance ) {
            ...
            echo '<div class="widget mkdf-blog-list-widget" ' . attika_mikado_get_inline_style( $widget_styles ) . '>';
