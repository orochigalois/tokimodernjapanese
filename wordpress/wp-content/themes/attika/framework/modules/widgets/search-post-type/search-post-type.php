...
if ( class_exists( 'AttikaCoreClassWidget' ) ) {
    class AttikaMikadoClassSearchPostType extends AttikaCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_search_post_type',
                esc_html__( 'Attika Search Post Type', 'attika' ),
                array( 'description' => esc_html__( 'Select post type that you want to be searched for', 'attika' ) )
            );
        ...
        public function widget( $args, $instance ) {
            ...
            <div class="widget mkdf-search-post-type-widget">
                <div data-post-type="<?php echo esc_attr( $post_type ); ?>" <?php attika_mikado_class_attribute( $search_type_class ); ?>>
                    <input class="mkdf-post-type-search-field" value="" placeholder="<?php esc_attr_e( 'Search here', 'attika' ) ?>">
