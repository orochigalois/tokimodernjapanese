...
if ( ! function_exists( 'attika_mikado_content_bottom_options_map' ) ) {
	function attika_mikado_content_bottom_options_map() {
		
		$panel_content_bottom = attika_mikado_add_admin_panel(
			array(
				'page'  => '_page_page',
				'name'  => 'panel_content_bottom',
				'title' => esc_html__( 'Content Bottom Area Style', 'attika' )
			)
		);
		...
		$enable_content_bottom_area_container = attika_mikado_add_admin_container(
			array(
				'parent'          => $panel_content_bottom,
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Widget Area to Display', 'attika' ),
				'description'   => esc_html__( 'Choose a Content Bottom widget area to display', 'attika' ),
	...
	add_action( 'attika_mikado_action_additional_page_options_map', 'attika_mikado_content_bottom_options_map' );
}