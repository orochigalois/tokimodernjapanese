...
if ( ! function_exists( 'attika_mikado_get_title_types_options' ) ) {
	function attika_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'attika_mikado_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'attika_mikado_get_title_type_default_options' ) ) {
	function attika_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'attika_mikado_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('attika_mikado_title_options_map') ) {
	function attika_mikado_title_options_map() {
		$title_type_options        = attika_mikado_get_title_types_options();
		$title_type_default_option = attika_mikado_get_title_type_default_options();
		...
		$panel_title = attika_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'attika')
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'attika' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = attika_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				attika_mikado_add_admin_field(
					...
					attika_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'attika' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'attika_mikado_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = attika_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = attika_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'attika' ),
					'description' => esc_html__( 'Define styles for page title', 'attika' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = attika_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = attika_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = attika_mikado_add_admin_row(
					array(
			...
			attika_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'attika' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = attika_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'attika' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'attika' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = attika_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = attika_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = attika_mikado_add_admin_row(
					array(
		...
		do_action( 'attika_mikado_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'attika_mikado_action_options_map', 'attika_mikado_title_options_map', attika_mikado_set_options_map_position( 'title' ) );
}