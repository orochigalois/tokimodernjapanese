...
$blog_list_image_id  = ! empty( $image_meta ) && attika_mikado_blog_item_has_link() ? attika_mikado_get_attachment_id_from_url( $image_meta ) : '';
?>

<?php if ( $has_featured ) { ?>
	<div class="mkdf-post-image">
		<?php if ( attika_mikado_blog_item_has_link() ) { ?>
		...
		<?php } ?>
		<?php do_action('attika_mikado_action_blog_inside_image_tag')?>
	</div>
<?php } ?>