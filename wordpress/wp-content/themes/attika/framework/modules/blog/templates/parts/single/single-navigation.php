<?php
$blog_single_navigation = attika_mikado_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = attika_mikado_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
			...
			<?php
				...
				$post_navigation = array(
					'prev' => array(
                        ...
                        'label' => '<span class="mkdf-blog-single-nav-label">'.esc_html__('previous', 'attika').'</span>'
					),
					'next' => array(
						'mark' => '<span class="mkdf-blog-single-nav-mark arrow_carrot-right"></span>',
						'label' => '<span class="mkdf-blog-single-nav-label">'.esc_html__('next', 'attika').'</span>'
					)
				);
