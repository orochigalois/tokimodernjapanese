<?php
namespace AttikaCore\CPT\Shortcodes\BlogList;
...
class BlogList implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog List', 'attika' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							...
							esc_html__( 'Boxed', 'attika' )    => 'boxed',
							esc_html__( 'Masonry', 'attika' )  => 'masonry',
							esc_html__( 'Simple', 'attika' )   => 'simple',
							esc_html__( 'Minimal', 'attika' )  => 'minimal'
						),
						'save_always' => true
					),
					array(
						...
						'heading'    => esc_html__( 'Number of Posts', 'attika' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						'type'        => 'autocomplete',
						'param_name'  => 'category',
						'heading'     => esc_html__( 'Category', 'attika' ),
						'description' => esc_html__( 'Enter one category slug (leave empty for showing all categories)', 'attika' )
					),
					array(
						'type'       => 'dropdown',
						'param_name' => 'image_size',
						'heading'    => esc_html__( 'Image Size', 'attika' ),
						'value'      => array(
							...
							esc_html__( 'Thumbnail', 'attika' ) => 'thumbnail',
					...
					array(
						...
						'group'      => esc_html__( 'Post Info', 'attika' )
					),
					array(
						'type'       => 'dropdown',
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Image', 'attika' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Section', 'attika' ),
						'value'      => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'type', 'value'   => array( 'standard', 'boxed', 'masonry' ) ),
						'group'      => esc_html__( 'Post Info', 'attika' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Author', 'attika' ),
						'value'      => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Date', 'attika' ),
						'value'      => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'attika' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Category', 'attika' ),
						'value'      => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'attika' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Comments', 'attika' ),
					...
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Like', 'attika' ),
						'value'      => array_flip( attika_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'attika' )
					),
					array(
						...
						'heading'    => esc_html__( 'Enable Post Info Share', 'attika' ),
						'value'      => array_flip( attika_mikado_get_yes_no_select_array( false ) ),
						'dependency' => Array( 'element' => 'post_info_section', 'value' => array( 'yes' ) ),
						'group'      => esc_html__( 'Post Info', 'attika' )
					),
					array(
						...
						'heading'    => esc_html__( 'Pagination Type', 'attika' ),
						'value'      => array(
							esc_html__( 'None', 'attika' )            => 'no-pagination',
							esc_html__( 'Standard', 'attika' )        => 'standard-shortcodes',
							esc_html__( 'Load More', 'attika' )       => 'load-more',
							esc_html__( 'Infinite Scroll', 'attika' ) => 'infinite-scroll'
						),
						'group'      => esc_html__( 'Additional Features', 'attika' )
					)
				)
			)
		);
	...
	public function render( $atts, $content = null ) {
		...
		attika_mikado_get_module_template_part( 'shortcodes/blog-list/holder', 'blog', $params['type'], $params );
	...
	public function blogCategoryAutocompleteSuggester( $query ) {
		...
		if ( is_array( $post_meta_infos ) && ! empty( $post_meta_infos ) ) {
			foreach ( $post_meta_infos as $value ) {
				...
				$data['label'] = ( ( strlen( $value['category_title'] ) > 0 ) ? esc_html__( 'Category', 'attika' ) . ': ' . $value['category_title'] : '' );
				$results[]     = $data;
			}
		}
		...
		if ( ! empty( $query ) ) {
			...
			if ( is_object( $category ) ) {
				...
				if ( ! empty( $category_title ) ) {
					$category_title_display = esc_html__( 'Category', 'attika' ) . ': ' . $category_title;
				}
