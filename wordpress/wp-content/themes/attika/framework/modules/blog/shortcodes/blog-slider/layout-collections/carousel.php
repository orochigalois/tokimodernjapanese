	...
	<div class="mkdf-blog-slider-item-inner">
		...
		<div class="mkdf-bli-content">
			...
			<div class="mkdf-bli-excerpt">
				<?php attika_mikado_get_module_template_part( 'templates/parts/excerpt', 'blog', '', $params ); ?>
				<?php attika_mikado_get_module_template_part( 'templates/parts/post-info/read-more', 'blog', '', $params ); ?>
			</div>
		</div>
	</div>
</li>