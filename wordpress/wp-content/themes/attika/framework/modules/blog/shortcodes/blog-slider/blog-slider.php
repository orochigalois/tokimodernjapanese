<?php
namespace AttikaCore\CPT\Shortcodes\BlogSlider;
...
class BlogSlider implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		vc_map(
			array(
				'name'                      => esc_html__( 'Blog Slider', 'attika' ),
				'base'                      => $this->base,
				...
				'params'                    => array(
					array(
						...
						'value'       => array(
							esc_html__( 'Slider', 'attika' )            => 'slider',
							esc_html__( 'Carousel', 'attika' )          => 'carousel',
							esc_html__( 'Carousel Centered', 'attika' ) => 'carousel-centered'
						),
						'save_always' => true
					),
					array(
	...
	public function render( $atts, $content = null ) {
		...
		attika_mikado_get_module_template_part( 'shortcodes/blog-slider/holder', 'blog', '', $params );
