...
<form action="<?php echo esc_url( home_url( '/' ) ); ?>" class="mkdf-search-slide-window-top" method="get">
	...
	<?php } ?>
		<div class="mkdf-search-form-inner">
			<span <?php attika_mikado_class_attribute( $search_submit_icon_class ); ?>>
	            <?php echo attika_mikado_get_icon_sources_html( 'search', false, array( 'search' => 'yes' ) ); ?>
			</span>
			<input type="text" placeholder="<?php esc_attr_e( 'Search', 'attika' ); ?>" name="s" class="mkdf-swt-search-field" autocomplete="off"/>
