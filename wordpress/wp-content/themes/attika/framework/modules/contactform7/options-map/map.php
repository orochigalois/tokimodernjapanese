...
if ( ! function_exists('attika_mikado_contact_form_7_options_map') ) {

	function attika_mikado_contact_form_7_options_map() {
		
		attika_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'attika' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = attika_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'attika' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'attika' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'attika' ),
			)
		);
		...
		$typography_text_row2 = attika_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = attika_mikado_add_admin_row(
			array(
		...
		$typography_label_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'attika' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = attika_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = attika_mikado_add_admin_row(
			array(
		...
		$background_border_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'attika' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'attika' )
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'attika' )
			)
		);
		
		$background_border_row2 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'attika' ),
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'attika' )
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'attika' )
			)
		);
		
		$background_border_row3 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Width', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'attika' ),
				'description' => esc_html__('Setup form elements padding', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = attika_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'attika' ),
				'description' => esc_html__( 'Setup form elements margin', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = attika_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'attika' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'attika' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'attika' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'attika' ),
				'description' => esc_html__( 'Setup button text typography', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = attika_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = attika_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = attika_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'attika' ),
				'description' => esc_html__( 'Setup button background and border style', 'attika' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'attika' )
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'attika' )
			)
		);
		
		$button_background_border_row2 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'attika' )
			)
		);
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'attika' )
			)
		);
		
		$button_background_border_row3 = attika_mikado_add_admin_row(
			array(
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'attika' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		attika_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'attika' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = attika_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'attika')
		));

		//Text Typography

		$typography_text_group = attika_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'attika'),
			'description'	=> esc_html__('Setup typography for form elements text', 'attika'),
		...
		$typography_text_row1 = attika_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = attika_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = attika_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = attika_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'attika'),
			'description'	=> esc_html__('Setup typography for form elements label', 'attika'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = attika_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = attika_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = attika_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'attika'),
			'description'	=> esc_html__('Setup form elements background and border style', 'attika'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = attika_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = attika_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = attika_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = attika_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'attika'),
			'description'	=> esc_html__('Setup form elements padding', 'attika' ),
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = attika_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = attika_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'attika'),
			'description'	=> esc_html__('Setup form elements margin', 'attika'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = attika_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = attika_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'attika'),
			'description'	=> esc_html__('Setup button text typography', 'attika'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = attika_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = attika_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = attika_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'attika'),
			'description'	=> esc_html__('Setup button background and border style', 'attika'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = attika_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = attika_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = attika_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = attika_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'attika')
        ));
        ...
        $typography_label_row3 = attika_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = attika_mikado_add_admin_row(array(
	...
	add_action( 'attika_mikado_action_options_map', 'attika_mikado_contact_form_7_options_map', attika_mikado_set_options_map_position( 'contact_form_7' ) );
}