...
namespace AttikaCore\CPT\Shortcodes\ProductListCarousel;
...
class ProductListCarousel implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Product List - Carousel', 'attika' ),
					'base'                      => $this->base,
					...
					'params'                    => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Number Of Visible Items', 'attika' ),
							'value'       => array(
								esc_html__( 'One', 'attika' )   => '1',
								esc_html__( 'Two', 'attika' )   => '2',
								esc_html__( 'Three', 'attika' ) => '3',
								esc_html__( 'Four', 'attika' )  => '4',
								esc_html__( 'Five', 'attika' )  => '5',
								esc_html__( 'Six', 'attika' )   => '6'
							),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'attika' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_loop',
							'heading'     => esc_html__( 'Enable Slider Loop', 'attika' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Autoplay', 'attika' ),
							'value'       => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'attika' )
						),
						array(
							...
							'heading'     => esc_html__( 'Slide Duration', 'attika' ),
							'description' => esc_html__( 'Default value is 5000 (ms)', 'attika' ),
							'group'       => esc_html__( 'Slider Settings', 'attika' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'slider_speed_animation',
							'heading'     => esc_html__( 'Slide Animation Duration', 'attika' ),
							'description' => esc_html__( 'Speed of slide animation in milliseconds. Default value is 600.', 'attika' ),
							'group'       => esc_html__( 'Slider Settings', 'attika' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'slider_navigation',
							'heading'     => esc_html__( 'Enable Slider Navigation Arrows', 'attika' ),
							'value'       => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'attika' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Navigation Skin', 'attika' ),
							'value'      => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Pagination', 'attika' ),
							'value'       => array_flip( attika_mikado_get_yes_no_select_array( false, true ) ),
							'save_always' => true,
							'group'       => esc_html__( 'Slider Settings', 'attika' )
						),
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Skin', 'attika' ),
							'value'      => array(
								esc_html__( 'Default', 'attika' ) => 'default',
								esc_html__( 'Light', 'attika' )   => 'light'
							),
						...
						array(
							...
							'heading'    => esc_html__( 'Slider Pagination Position', 'attika' ),
							'value'      => array(
								esc_html__( 'Below Carousel', 'attika' )  => 'bellow-slider',
								esc_html__( 'Inside Carousel', 'attika' ) => 'inside-slider'
							),
							'dependency' => array( 'element' => 'slider_pagination', 'value' => array( 'yes' ) ),
							'group'      => esc_html__( 'Slider Settings', 'attika' )
						),
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_mikado_get_woo_shortcode_module_template_part( 'templates/product-list', 'product-list-carousel', $params['type'], $params, $additional_params );
