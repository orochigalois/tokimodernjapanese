...
if ( ! function_exists( 'attika_mikado_add_simple_line_icon_pack' ) ) {
	function attika_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new AttikaMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_simple_line_icon_pack_option' ) ) {
	function attika_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'attika_mikado_filter_add_icon_pack_into_social_options', 'attika_mikado_add_simple_line_icon_pack_option' );
}

class AttikaMikadoClassSimpleLineIcons implements iAttikaMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'attika'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'attika'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'attika'),
            'icon-social-facebook'    => esc_html__('Facebook', 'attika'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'attika'),
            'icon-social-github'      => esc_html__('Github', 'attika'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'attika'),
            'icon-social-instagram'   => esc_html__('Instagram', 'attika'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'attika'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'attika'),
            'icon-social-reddit'      => esc_html__('Reddit', 'attika'),
            'icon-social-skype'       => esc_html__('Skype', 'attika'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'attika'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'attika'),
            'icon-social-spotify'     => esc_html__('Spotify', 'attika'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'attika'),
            'icon-social-twitter'     => esc_html__('Twitter', 'attika'),
            'icon-social-youtube'     => esc_html__('Youtube', 'attika')
        );
    }
	...
	public function getDropdownCartIcon() {
		...
		return $this->render('icon-basket');
	}
}