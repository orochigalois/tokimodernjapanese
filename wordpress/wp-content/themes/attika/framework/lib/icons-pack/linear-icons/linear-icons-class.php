...
if ( ! function_exists( 'attika_mikado_add_linear_icon_pack' ) ) {
	function attika_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new AttikaMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_linear_icon_pack_option' ) ) {
	function attika_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_linear_icon_pack_option' );
}

class AttikaMikadoClassLinearIcons implements iAttikaMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
