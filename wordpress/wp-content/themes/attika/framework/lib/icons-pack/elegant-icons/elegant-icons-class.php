...
if ( ! function_exists( 'attika_mikado_add_font_elegant_icon_pack' ) ) {
	function attika_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new AttikaMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_font_elegant_icon_pack_option' ) ) {
	function attika_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'attika_mikado_filter_add_icon_pack_into_social_options', 'attika_mikado_add_font_elegant_icon_pack_option' );
}

class AttikaMikadoClassIconsFontElegant implements iAttikaMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
