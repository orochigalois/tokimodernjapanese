...
if ( ! function_exists( 'attika_mikado_add_dripicons_icon_pack' ) ) {
	function attika_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new AttikaMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_dripicons_icon_pack_option' ) ) {
	function attika_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_dripicons_icon_pack_option' );
}

class AttikaMikadoClassDripicons implements iAttikaMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
