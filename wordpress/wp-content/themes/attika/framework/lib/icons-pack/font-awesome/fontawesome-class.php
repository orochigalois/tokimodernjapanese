...
if ( ! function_exists( 'attika_mikado_add_font_awesome_icon_pack' ) ) {
	function attika_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new AttikaMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_font_awesome_icon_pack_option' ) ) {
	function attika_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'attika_mikado_filter_add_icon_pack_into_social_options', 'attika_mikado_add_font_awesome_icon_pack_option' );
}

class AttikaMikadoClassIconsFontAwesome implements iAttikaMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
