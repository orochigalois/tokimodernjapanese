...
if ( ! function_exists( 'attika_mikado_add_linea_icon_pack' ) ) {
	function attika_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new AttikaMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_linea_icon_pack_option' ) ) {
	function attika_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_linea_icon_pack_option' );
}

class AttikaMikadoClassLineaIcons implements iAttikaMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
