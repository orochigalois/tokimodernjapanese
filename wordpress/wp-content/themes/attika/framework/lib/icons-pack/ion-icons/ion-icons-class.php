...
if ( ! function_exists( 'attika_mikado_add_ion_icon_pack' ) ) {
	function attika_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new AttikaMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_collection', 'attika_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'attika_mikado_add_ion_icon_pack_option' ) ) {
	function attika_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'attika' );
		
		return $options;
	}
	
	add_filter( 'attika_mikado_filter_add_icon_pack_into_options', 'attika_mikado_add_ion_icon_pack_option' );
	add_filter( 'attika_mikado_filter_add_icon_pack_into_social_options', 'attika_mikado_add_ion_icon_pack_option' );
}

class AttikaMikadoClassIonIcons implements iAttikaMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
