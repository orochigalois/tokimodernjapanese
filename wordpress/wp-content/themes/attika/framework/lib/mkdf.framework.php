...
/*
   Class: AttikaMikadoClassFramework
...
class AttikaMikadoClassFramework {
	...
	private function __construct() {
		$this->mkdOptions         = AttikaMikadoClassOptions::get_instance();
		$this->mkdMetaBoxes       = AttikaMikadoClassMetaBoxes::get_instance();
		$this->mkdTaxonomyOptions = AttikaMikadoClassTaxonomyOptions::get_instance();
		$this->mkdUserOptions     = AttikaMikadoClassUserOptions::get_instance();
		$this->mkdDashboardOptions = AttikaMikadoClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( AttikaMikadoClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class AttikaMikadoClassSkinManager
 *
...
class AttikaMikadoClassSkinManager {
	...
	/**
	 * @see AttikaMikadoClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = MIKADO_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'attika' );
...
/**
 * Class AttikaMikadoClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class AttikaMikadoClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( attika_mikado_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.mkdSCIcon = '<?php echo attika_mikado_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.mkdSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'attika' ) ?>';
		</script>
	<?php }
...
/*
   Class: AttikaMikadoClassOptions
...
class AttikaMikadoClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $attika_mikado_global_options ) ) {
			return $attika_mikado_global_options[ $key ];
...
/*
   Class: AttikaMikadoClassAdminPage
   A class that initializes Mikado Admin Page
*/
class AttikaMikadoClassAdminPage implements iAttikaMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title_label = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new AttikaMikadoClassFieldFactory();
		$this->slug    = $slug;
	...
	public function renderChild( iAttikaMikadoInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: AttikaMikadoClassMetaBoxes
...
/*
   Class: AttikaMikadoClassMetaBox
   A class that initializes Mikado Meta Box
*/
class AttikaMikadoClassMetaBox implements iAttikaMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $attika_mikado_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: AttikaMikadoClassTaxonomyOptions
   A class that initializes AttikaMikadoClass Taxonomy Options
*/
class AttikaMikadoClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: AttikaMikadoClassTaxonomyOption
   A class that initializes AttikaMikadoClass Taxonomy Option
*/
class AttikaMikadoClassTaxonomyOption implements iAttikaMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new AttikaMikadoClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: AttikaMikadoClassUserOptions
   A class that initializes AttikaMikadoClass User Options
*/
class AttikaMikadoClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: AttikaMikadoClassUserOption
   A class that initializes AttikaMikadoClass User Option
*/
class AttikaMikadoClassUserOption implements iAttikaMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new AttikaMikadoClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: AttikaMikadoClassDashboardOptions
   A class that initializes AttikaMikadoClass Dashboard Options
*/
class AttikaMikadoClassDashboardOptions {
	private static $instance;
...
/*
   Class: AttikaMikadoClassDashboardOption
   A class that initializes AttikaMikadoClass Dashboard Option
*/
class AttikaMikadoClassDashboardOption implements iAttikaMikadoInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new AttikaMikadoClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'attika_mikado_init_framework_variable' ) ) {
	function attika_mikado_init_framework_variable() {
		global $attika_mikado_global_Framework;
		
		$attika_mikado_global_Framework = AttikaMikadoClassFramework::get_instance();
		$mkdSkinManager                 = new AttikaMikadoClassSkinManager();
		$attika_mikado_global_Framework->setSkin( $mkdSkinManager->getSkin() );
	}
	
	add_action( 'attika_mikado_action_before_options_map', 'attika_mikado_init_framework_variable' );
}
?>