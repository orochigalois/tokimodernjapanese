...
if ( $row_content_width !== 'grid' ) {
	...
	if ( ! empty( $simple_background_image ) ) {
        $css_classes[]        = 'mkdf-row-with-background-image';
...
if ($enable_parallax_background_elements === 'yes') {
    $mkdf_parallax_elements .= '<div class="mkdf-row-parallax-background-elements-holder mkdf-parallax-elements-'.$parallax_background_elements_vertical_alignment.'">';
...
if ( $row_content_width === 'grid' ) {
	$mkdf_row_wrapper_start .= '<div class="mkdf-row-grid-section-wrapper ' . esc_attr( $grid_row_classes ) . '" ' . esc_attr( $grid_row_datas ) . ' ' . attika_mikado_get_inline_style( $mkdf_grid_row_styles ) . '><div class="mkdf-row-grid-section">';
