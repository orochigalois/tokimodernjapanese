...
if ( $max_value && $min_value === $max_value ) {
	...
	$label = ! empty( $args['product_name'] ) ? sprintf( esc_html__( '%s quantity', 'attika' ), wp_strip_all_tags( $args['product_name'] ) ) : esc_html__( 'Quantity', 'attika' );
	?>
	...
	<?php do_action( 'woocommerce_before_quantity_input_field' ); ?>
		...
		<input
			...
			title="<?php echo esc_attr_x( 'Qty', 'Product quantity input tooltip', 'attika' ); ?>"
			size="4"
