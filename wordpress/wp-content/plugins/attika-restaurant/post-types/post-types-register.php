<?php
namespace AttikaRestaurant\CPT;

use AttikaRestaurant\Lib;

/**
 * Class PostTypesLoader
 * @package AttikaRestaurant\CPT
 */
class PostTypesRegister {
    ...
    private function addPostTypes() {
	    $cpt_class_name = apply_filters('attika_restaurant_filter_register_custom_post_types', $cpt_class_name = array());
