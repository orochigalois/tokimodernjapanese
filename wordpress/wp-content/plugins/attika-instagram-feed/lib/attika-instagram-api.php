...
include 'attika-instagram-helper.php';

/**
 * Class AttikaInstagramApi
 */
class AttikaInstagramApi {
	...
	const INSTAGRAM_CODE = 'attika_instagram_code';
	const INSTAGRAM_USER_ID = 'attika_instagram_user_id';
	const INSTAGRAM_TOKEN = 'attika_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'attika_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'attika_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'attika_facebook_code';
	const FACEBOOK_TOKEN = 'attika_facebook_access_token';

	const CONNECTION_TYPE = 'attika_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new AttikaInstagramHelper();
	}

	/**
	 * @return AttikaInstagramApi
	 */
	 ...
	 *
	 * @see AttikaInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see AttikaInstagramApi::instagramExchangeCodeForToken()
	 */
