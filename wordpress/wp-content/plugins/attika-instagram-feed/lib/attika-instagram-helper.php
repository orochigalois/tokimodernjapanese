...
/**
 * Class AttikaInstagramHelper
 */
class AttikaInstagramHelper {
	/**
	 * Generates HTML for given image from Instagram feed. Defines attika_instagram_image_atts filter
	 *
	...
	public function getImageHTML( $image ) {
		...
		$imageAtts = apply_filters( 'attika_instagram_image_atts',
			array(
