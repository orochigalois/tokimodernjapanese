<?php
namespace AttikaCore\CPT\Shortcodes\ClientsCarouselItem;
...
class ClientsCarouselItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Clients Item', 'attika-core' ),
					'base'                    => $this->getBase(),
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Hover Image', 'attika-core' ),
							'description' => esc_html__( 'Select image from media library', 'attika-core' )
						),
						array(
							'type'        => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_core_get_shortcode_module_template_part( 'templates/clients-carousel-item', 'clients-carousel', '', $params );
