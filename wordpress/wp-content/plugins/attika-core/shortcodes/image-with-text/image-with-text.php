<?php
namespace AttikaCore\CPT\Shortcodes\ImageWithText;
...
class ImageWithText implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image With Text', 'attika-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
                        ...
                        array(
                            ...
                            'heading'    => esc_html__( 'Text Alignment', 'attika-core' ),
                            'value'      => array(
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_core_get_shortcode_module_template_part( 'templates/image-with-text', 'image-with-text', '', $params );
	...
	private function getHolderClasses( $params ) {
		...
		$holderClasses[] = ! empty( $params['text_alignment'] ) ? 'mkdf-iwt-align-' . $params['text_alignment'] : '';
