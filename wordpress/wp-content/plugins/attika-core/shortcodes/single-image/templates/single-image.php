<div class="mkdf-single-image-holder <?php echo esc_attr($holder_classes); ?>" <?php echo attika_mikado_get_inline_attrs($parallax_data); ?>>
    <div class="mkdf-si-inner" <?php echo attika_mikado_get_inline_style($holder_styles); ?>>
