...
class Process implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'            => esc_html__( 'Process', 'attika-core' ),
					'base'            => $this->base,
					...
					'params'          => array(
						...
						array(
							...
							'value'       => array_flip( attika_mikado_get_number_of_columns_array( false, array( 'one', 'five', 'six' ) ) ),
							'save_always' => true
						),
						array(
							'type'        => 'dropdown',
							...
							'value'       => array(
								esc_html__( 'Default None', 'attika-core' ) => '',
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_core_get_shortcode_module_template_part( 'templates/process-template', 'process', '', $params );
