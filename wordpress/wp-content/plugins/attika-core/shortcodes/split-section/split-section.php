<?php
namespace AttikaCore\CPT\Shortcodes\SplitSection;
...
class SplitSection implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Split Section', 'attika-core' ),
					'base'     => $this->base,
					...
					'params'   => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Image Position', 'attika-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Content Background Color', 'attika-core' )
						),
						array(
							'type'       => 'textfield',
							'param_name' => 'title',
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'text_tag',
							'heading'     => esc_html__( 'Text Tag', 'attika-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Text Top Margin (px or %)', 'attika-core' ),
							'dependency' => array( 'element' => 'text', 'not_empty' => true )
						),
						array(
							'type'       => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Button Type', 'attika-core' ),
							'value'       => array(
								esc_html__( 'Solid', 'attika-core' )   => 'solid',
								esc_html__( 'Outline', 'attika-core' ) => 'outline',
								esc_html__( 'Text', 'attika-core' )    => 'simple'
							),
							'save_always' => true,
							'dependency'  => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'       => esc_html__( 'Button Style', 'attika-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'button_size',
							'heading'     => esc_html__( 'Button Size', 'attika-core' ),
							'value'       => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Button Color', 'attika-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'attika-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Color', 'attika-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'attika-core' ),
						),
						array(
							...
							'heading'    => esc_html__( 'Button Background Color', 'attika-core' ),
						...
						array(
							...
							'heading'    => esc_html__( 'Button Hover Background Color', 'attika-core' ),
							'dependency' => array( 'element' => 'button_type', 'value' => array( 'solid' ) ),
							'group'      => esc_html__( 'Button Style', 'attika-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Border Color', 'attika-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'attika-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Hover Border Color', 'attika-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'attika-core' )
						),
						array(
							...
							'heading'    => esc_html__( 'Button Top Margin (px or %)', 'attika-core' ),
							'dependency' => array( 'element' => 'button_text', 'not_empty' => true ),
							'group'      => esc_html__( 'Button Style', 'attika-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Responsive Breakpoint', 'attika-core' ),
							'value'       => array(
								esc_html__( 'Never', 'attika-core' )        => '',
							...
							'description' => esc_html__( 'Choose on which stage you want to break image and text content to be one under other', 'attika-core' ),
							'save_always' => true
						)
					)
				)
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_core_get_shortcode_module_template_part( 'templates/split-section', 'split-section', '', $params );
	...
	private function getTextStyles( $params ) {
		...
		if ( $params['text_top_margin'] !== '' ) {
			if ( attika_mikado_string_ends_with( $params['text_top_margin'], '%' ) || attika_mikado_string_ends_with( $params['text_top_margin'], 'px' ) ) {
