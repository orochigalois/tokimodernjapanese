<?php
namespace AttikaCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'attika-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'attika-core' ) => 'accordion',
								esc_html__( 'Toggle', 'attika-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
							...
							'value'      => array(
								esc_html__( 'Boxed', 'attika-core' )  => 'boxed',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'attika-core' ),
							'value'      => array(
								esc_html__( 'Default', 'attika-core' ) => '',
								esc_html__( 'White', 'attika-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = attika_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
