<div class="mkdf-fsis-item">
	<div class="mkdf-fsis-image" <?php attika_mikado_inline_style( $image_styles ); ?>>
		<div class="mkdf-fsis-image-wrapper">
			<div class="mkdf-fsis-image-inner">
				...
				<?php } ?>
				<?php if ( ! empty( $title ) ) { ?>
					<<?php echo esc_attr( $title_tag ); ?> class="mkdf-fsis-title" <?php echo attika_mikado_get_inline_style( $title_styles ); ?>><?php echo wp_kses( $title, array( 'br' => true ) ); ?></<?php echo esc_attr( $title_tag ); ?>>
				<?php } ?>
				<?php if ( ! empty( $subtitle ) ) { ?>
					<<?php echo esc_attr( $subtitle_tag ); ?> class="mkdf-fsis-subtitle" <?php echo attika_mikado_get_inline_style( $subtitle_styles ); ?>><?php echo wp_kses( $subtitle, array( 'br' => true ) ); ?></<?php echo esc_attr( $subtitle_tag ); ?>>
				<?php } ?>
			</div>
		</div>
	</div>
