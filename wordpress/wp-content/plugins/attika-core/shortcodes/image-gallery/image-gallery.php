<?php
namespace AttikaCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'attika-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'attika-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'attika-core' ) => 'grid',
								esc_html__( 'Masonry', 'attika-core' )    => 'masonry',
								esc_html__( 'Slider', 'attika-core' )     => 'slider',
								esc_html__( 'Carousel', 'attika-core' )   => 'carousel'
							),
							'save_always' => true,
							'admin_label' => true
						),
						...
						array(
							...
							'description' => esc_html__( 'Enter image size. Example: thumbnail, medium, large, full or other sizes defined by current theme. Alternatively enter image size in pixels: 200x100 (Width x Height). Leave empty to use "full" size', 'attika-core' )
						),
						array(
							'type'        => 'dropdown',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'attika-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'attika-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'attika-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'attika-core' ),
							'value'       => array_flip( attika_mikado_get_yes_no_select_array( false ) ),
							'save_always' => true,
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
