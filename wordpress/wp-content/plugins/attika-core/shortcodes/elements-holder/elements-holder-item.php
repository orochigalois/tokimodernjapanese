...
class ElementsHolderItem implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Elements Holder Item', 'attika-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'heading'     => esc_html__( 'Padding', 'attika-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'attika-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'horizontal_alignment',
							'heading'    => esc_html__( 'Horizontal Alignment', 'attika-core' ),
							'value'      => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Vertical Alignment', 'attika-core' ),
							'value'      => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Default (No Animation)', 'attika-core' )   => '',
						...
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 1367px-1600px', 'attika-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'attika-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'attika-core' )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'item_padding_1025_1366',
							'heading'     => esc_html__( 'Padding on screen size between 1025px-1366px', 'attika-core' ),
							'description' => esc_html__( 'Please insert padding in format top right bottom left. For example 10px 0 10px 0', 'attika-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'attika-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 768px-1024px', 'attika-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'attika-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'attika-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size between 680px-768px', 'attika-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'attika-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'attika-core' )
						),
						array(
							...
							'heading'     => esc_html__( 'Padding on screen size bellow 680px', 'attika-core' ),
							'description' => esc_html__( 'Please insert padding in format 0px 10px 0px 10px', 'attika-core' ),
							'group'       => esc_html__( 'Width & Responsiveness', 'attika-core' )
						)
					)
	...
	public function render( $atts, $content = null ) {
		...
		$html = attika_core_get_shortcode_module_template_part( 'templates/elements-holder-item-template', 'elements-holder', '', $params );
