...
if ( ! class_exists( 'AttikaCoreDashboardRestAPI' ) ) {
	 ...
	 */
	class AttikaCoreDashboardRestAPI {
		...
		public function __construct() {
			...
			add_filter( 'attika_core_dashboard_filter_js_global_variables', array( $this, 'localize_script' ) );
	...
	AttikaCoreDashboardRestAPI::get_instance();
}