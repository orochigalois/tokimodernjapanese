<?php
if ( ! function_exists( 'attika_mikado_init_google_fonts_array' ) ) {
    function attika_mikado_init_google_fonts_array() {
        ...
        $attika_mikado_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'attika_mikado_init_google_fonts_array');
}