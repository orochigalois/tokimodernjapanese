...
class PortfolioProjectInfo implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'     => esc_html__( 'Portfolio Project Info', 'attika-core' ),
					'base'     => $this->getBase(),
					...
					'params'   => array(
						array(
							...
							'heading'     => esc_html__( 'Selected Project', 'attika-core' ),
							'settings'    => array(
								'sortable'      => true,
								'unique_values' => true
							),
							'description' => esc_html__( 'If you left this field empty then project ID will be of the current page', 'attika-core' )
						),
						array(
							'type'        => 'dropdown',
							'param_name'  => 'project_info_type',
							'heading'     => esc_html__( 'Project Info Type', 'attika-core' ),
							'value'       => array(
								esc_html__( 'Title', 'attika-core' )          => 'title',
								esc_html__( 'Category', 'attika-core' )       => 'category',
								esc_html__( 'Tag', 'attika-core' )            => 'tag',
								esc_html__( 'Author', 'attika-core' )         => 'author',
								esc_html__( 'Date', 'attika-core' )           => 'date',
								esc_html__( 'Featured Image', 'attika-core' ) => 'image'
							),
							'admin_label' => true
						),
						array(
							...
							'heading'     => esc_html__( 'Project Title Tag', 'attika-core' ),
							'value'       => array_flip( attika_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
							'description' => esc_html__( 'Set title tag for project title element', 'attika-core' ),
							'dependency'  => array( 'element' => 'project_info_type', 'value' => array( 'title' ) )
						),
						array(
							'type'        => 'textfield',
							'param_name'  => 'project_info_title',
							'heading'     => esc_html__( 'Project Info Label', 'attika-core' ),
							'description' => esc_html__( 'Add project info label before project info element/s', 'attika-core' )
						),
						array(
							'type'       => 'dropdown',
							'param_name' => 'project_info_title_tag',
							'heading'    => esc_html__( 'Project Info Label Tag', 'attika-core' ),
							'value'      => array_flip( attika_mikado_get_title_tag( true, array( 'p' => 'p' ) ) ),
