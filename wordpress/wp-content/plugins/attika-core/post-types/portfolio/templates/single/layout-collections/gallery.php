<?php
$gallery_classes   = '';
$number_of_columns = attika_mikado_get_meta_field_intersect( 'portfolio_single_gallery_columns_number' );
if ( ! empty( $number_of_columns ) ) {
	$gallery_classes .= ' mkdf-' . $number_of_columns . '-columns';
}
$space_between_items = attika_mikado_get_meta_field_intersect( 'portfolio_single_gallery_space_between_items' );
...
<div class="mkdf-ps-image-holder mkdf-ps-gallery-images mkdf-grid-list mkdf-disable-bottom-space <?php echo esc_attr($gallery_classes); ?>">
	<div class="mkdf-ps-image-inner mkdf-outer-space">
		<?php
		$media = attika_core_get_portfolio_single_media();
...
<div class="mkdf-grid-row">
	<div class="mkdf-grid-col-8">
		<?php attika_core_get_cpt_single_module_template_part('templates/single/parts/content', 'portfolio', $item_layout); ?>
	</div>
